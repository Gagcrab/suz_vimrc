...
" termguicolors might ruin the colours in a Linux terminal, needs testing
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => OS-specific and Fonts
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Set font according to system

" Windoze
if has("win32") || has("win64")
    set gfn=Iosevka\ Term\ SS02:h11,Fantasque\ Sans\ Mono:h11,Courier\ New\ Regular:h11
    set wildignore+=.git\*,.hg\*,.svn\*

    " Uncomment to use Cygwin bash as terminal on non-Cygwin Vim
    "set shell=C:\cygwin64\bin\bash.exe\ -login
    "set shellcmdflag=-c
    "set shellquote=\"

" I've never used Vim on a Mac, so these sizes may need updating
elseif has("mac") || has("macunix")
    set gfn=Iosevka\ Term\ SS02:h14,Fantasque\ Sans\ Mono:h14,Menlo:h14
    set wildignore+=*/.git/*,*/.hg/*,*/.svn/*

" Probably Linux
else
    set gfn=Iosevka\ Term\ SS02\ 11,Fantasque\ Sans\ Mono\ 11,Monospace\ 11
    set wildignore+=*/.git/*,*/.hg/*,*/.svn/*
...
" Turn persistent undo on, meaning that you can undo even when
